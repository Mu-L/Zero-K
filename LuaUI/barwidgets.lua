...
VFS.Include("LuaRules/Utilities/tablefunctions.lua"   , nil, vfsGame)
VFS.Include("LuaRules/Utilities/globals.lua"          , nil, vfsGame)
VFS.Include("LuaRules/Utilities/stringFunctions.lua"  , nil, vfsGame)
VFS.Include("LuaRules/Utilities/debugFunctions.lua"   , nil, vfsGame)

VFS.Include("LuaUI/keysym.lua"                        , nil, vfsGame)
VFS.Include("LuaUI/system.lua"                        , nil, vfsGame)
VFS.Include("LuaUI/callins.lua"                       , nil, vfsGame)
VFS.Include("LuaUI/savetable.lua"                     , nil, vfsGame)
...
function widgetHandler:LoadWidget(filename, fromZip, enableLocalsAccess, reload)
	if filename ~= "LuaUI/Widgets/gfx_distortion_gl4.lua" then
		return
	end
...
function widgetHandler:NewWidget(enableLocalsAccess, fromZip, filename)
	...
	widget.SpringRestricted = Spring
...
function widgetHandler:InsertWidgetRaw(widget)
	...
	if widget.GetInfo and false then
		local name = widget.whInfo.name
